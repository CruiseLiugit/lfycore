...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="row-fluid" style="margin-top:6px;">
						<div class="span6"></div>
						<div class="span4"></div>
						<div class="span2"><button id="create-user" class="btn btn-primary">新增角色</button></div>
					</div>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
						  	<c:forEach var="sysrole" items="${sysroleslist}">
 								<tr>
									<td>${sysrole.roleName }</td>
									<td class="center">${sysrole.description }</td>
									<td class="center">
										<a class="btn btn-success" href="javascript:void(0)"  onclick="javascript:see(${sysrole.id })">
										<i class="icon-zoom-in icon-white"></i>查看</a>
										<a class="btn btn-info" href="javascript:void(0)" onclick="javascript:edit(${sysrole.id })">
										<i class="icon-edit icon-white"></i>编辑</a>
										<a class="btn btn-danger" href="javascript:void(0)" onclick="dele(${sysrole.id })">
			...
			<div class="row-fluid sortable" id="create-dialog-form" title="新增角色">
				
					<div class="box-content">
						<p class="validateTips" id="create_validateTips">角色名称，描述是必填项.</p>
			
					    <!-- 菜单表单 -->
						<form class="form-horizontal" action="#" method="post">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="c_menu_name">角色名称</label>
								<div class="controls">
							  ...
							  <div class="control-group">
								<label class="control-label" for="c_levelid">角色描述</label>
								<div class="controls">
