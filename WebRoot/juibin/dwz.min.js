...
//alert("navTabAjaxDone json ="+json);
var jsonobj = jQuery.parseJSON(json);
//alert("navTabAjaxDone jquery obj ="+jsonobj);
DWZ.ajaxDone(jsonobj);
//alert("navTabAjaxDone statusCode ="+jsonobj.statusCode);
if(jsonobj.statusCode==DWZ.statusCode.ok){
if(jsonobj.navTabId){
navTab.reloadFlag(jsonobj.navTabId);}else{
var $pagerForm=$("#pagerForm",navTab.getCurrentPanel());
var args=$pagerForm.size()>0?$pagerForm.serializeArray():{}
navTabPageBreak(args,jsonobj.rel);}
if("closeCurrent"==jsonobj.callbackType){
setTimeout(function(){navTab.closeCurrentTab(jsonobj.navTabId);},100);}else if("forward"==jsonobj.callbackType){
navTab.reload(jsonobj.forwardUrl);}else if("forwardConfirm"==jsonobj.callbackType){
alertMsg.confirm(jsonobj.confirmMsg||DWZ.msg("forwardConfirmMsg"),{
okCall:function(){
navTab.reload(jsonobj.forwardUrl);},
cancelCall:function(){
navTab.closeCurrentTab(jsonobj.navTabId);}});}else{
...
//alert("navTabAjaxDone json ="+json);
//alert("navTabAjaxDone json statusCode ="+json.statusCode);
var jsonobj = jQuery.parseJSON(json);	
/*
alert("navTabAjaxDone jquery obj ="+jsonobj);
alert("navTabAjaxDone obj statusCode ="+jsonobj.statusCode);
alert("navTabAjaxDone obj navTabId ="+jsonobj.navTabId);
alert("navTabAjaxDone obj forwardUrl ="+jsonobj.forwardUrl);
alert("navTabAjaxDone obj callbackType ="+jsonobj.callbackType);
*/
DWZ.ajaxDone(jsonobj);
if(jsonobj.statusCode==DWZ.statusCode.ok){
if(jsonobj.navTabId){
navTab.reload(jsonobj.forwardUrl,{navTabId:json.navTabId});}else if(jsonobj.rel){
var $pagerForm=$("#pagerForm",navTab.getCurrentPanel());
var args=$pagerForm.size()>0?$pagerForm.serializeArray():{}
navTabPageBreak(args,jsonobj.rel);}
if("closeCurrent"==jsonobj.callbackType){
